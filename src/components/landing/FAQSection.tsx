...
const faqs = [
  ...
  { q: "Em quanto tempo vou sentir resultados?", a: "A maioria das alunas relata melhora no inchaço e no intestino nos primeiros 3 a 7 dias. Os resultados mais profundos — sono, hormônios, disposição, libido — aparecem ao longo dos 21 dias." },
