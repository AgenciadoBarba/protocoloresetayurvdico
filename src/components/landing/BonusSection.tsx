...
const bonuses = [
  ...
  { ico: "👥", title: "Comunidade Anual + Encontros ao Vivo", desc: "Acesso por 1 ano com desafios, trocas e encontros. Para você não ficar sozinha depois dos 10 dias.", valor: "R$120/ano" },
];
  ...
  return (
    <section className="bg-card py-[60px] sm:py-20">
      <div ref={ref} className="reveal-section mx-auto w-full max-w-[1060px] px-5 sm:px-7 md:px-8">
        <span className="mb-3 block text-[11px] font-bold uppercase tracking-[3px] text-sage">Exclusivos para esta turma</span>
        <h2 className="font-display text-[30px] font-bold leading-[1.15] text-foreground mb-4 sm:text-[40px] md:text-[50px]">
          Bônus que valem mais<br /><em className="italic text-terra">do que o curso em si</em>
        </h2>
        <p className="mb-9 text-[15px] leading-[1.78] text-foreground-secondary sm:text-[17px]">
          Quem entrar agora recebe esses materiais extras sem custo adicional.
        </p>
